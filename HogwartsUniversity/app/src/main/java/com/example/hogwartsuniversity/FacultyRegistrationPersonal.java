...
public class FacultyRegistrationPersonal extends NavigationDrawer implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_faculty_registration_personal);
        drawerLayout=(DrawerLayout)findViewById(R.id.drawer_layout);
        LayoutInflater inflater = (LayoutInflater) this
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View contentView = inflater.inflate(R.layout.activity_faculty_registration_personal, null, false);
        drawerLayout.addView(contentView, 0);

        System.out.println(current_yr);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.btn_next:
                ...
                if(check==1)
                {
                    Intent next = new Intent(this,FacultyRegistrationJob.class);
            ...
            case R.id.btn_cancel:
                ...
                break;
            case R.id.txt_dob:
                datePickerDialog = new DatePickerDialog(FacultyRegistrationPersonal.this,new DatePickerDialog.OnDateSetListener(){
